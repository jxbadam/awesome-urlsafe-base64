...
const AlphabetType = require ("./alphabet-type.js");

const cache = {};

// validateAlphabet :: String -> Boolean
const validateAlphabet = function(alphabet) {
  switch(alphabet) {
...
const getCharacter62 = function(alphabet) {
...
// getCharacter63 :: String -> String
const getCharacter63 = function(alphabet) {
  validateAlphabet(alphabet)
...
const getPadding = function(alphabet) {
  validateAlphabet(alphabet)
...
const getAlphabet = function(alphabet) {
